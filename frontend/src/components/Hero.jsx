    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      ...
      <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
        ...
        <div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
          <p class="mb-4 font-semibold text-[#dd6b20] md:mb-6 md:text-lg xl:text-xl">Very proud to introduce</p>
  
          <h1 class="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl">We Change How Poeple Connect</h1>
          ...
          <div class="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start">
            <Link to="/register" class="inline-block rounded-lg bg-dBlue px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Start now</Link>
