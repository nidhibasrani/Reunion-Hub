...
const Footer = () => {
  return (
    <div class=" bg-dBlue text-white">
    <footer class="mx-auto max-w-screen-2xl  ">
      <div class=" px-10 mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
        <div class="col-span-full lg:col-span-2">
      
          <div class="mb-4 lg:-mt-2">
            <a href="/" class="inline-flex items-center gap-2 text-xl font-bold text-gray-100 md:text-2xl" aria-label="logo">
             <img src={image.logo} width={140} alt="" />
      ...
      <div class="bg-orange border-t border-gray-800 py-8 text-center text-sm text-gray-400 ">© 2024 - Reunion Hub. All rights reserved.</div>
    </footer>
  </div>
  );
}
