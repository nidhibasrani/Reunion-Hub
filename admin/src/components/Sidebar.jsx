  ...
  return (
    <>
      <div className="Sidebar py-10 px-3 montserrat flex justify-between items-center">
        ...
        <CiLogout className='text-red-500 text-3xl cursor-pointer' onClick={logoutHandler} />
      </div>

      <ul className='px-5 montserrat flex flex-col gap-2 text-white '>
        <li className="flex items-center"><MdPeople className="mr-2" /><Link to='/manage-users'>Manage Users</Link></li>
